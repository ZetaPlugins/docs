---
title: /lifestealz
description: Main command for LifeStealZ
icon: Compass
---
...
### /lifestealz graceperiod \[player] \<skip | reset>

Permission: `lifestealz.admin.graceperiod` (default: op)

This command skips or resets the grace period of a player.
