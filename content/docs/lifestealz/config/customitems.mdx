---
title: Custom Items
description: Learn how to create and modify custom items for LifeStealZ.
icon: Gem
---
...
[Official LifeStealZ Resourcepack on Modrinth](https://modrinth.com/resourcepack/lifestealzpack)
...
<Tabs items={['Recipe', 'Crafting Table']}>
<Tab value="Recipe">
```yaml
recipes:
    1:
...
<Tab value="Crafting Table">
![Recipe](/img/recipe_example.png)
</Tab>
</Tabs>
